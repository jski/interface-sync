...
function GearFinder:IsValidDungeon(dungeon, instanceId)
	local ident = dungeon
	if (not ZGV.IsRetail) and ident==0 and instanceId then ident="e_"..instanceId end
...
function GearFinder:ScoreDungeonItems()
	...
	local mythic_bonus = ZGV.IsRetail and ItemScore.MythicPlusMods[ZGV.db.profile.gear_23_plus]
